...
public class WishListDTO {
	...
	public String toString() {
		return "WishListDTO [wishListID=" + wishListID + ", isWished=" + isWished + ", wishListCnt=" + wishListCnt
				+ ", wishTotalCnt=" + wishTotalCnt + ", wishListAddTime=" + wishListAddTime + ", memberID=" + memberID
				+ ", memberGender=" + memberGender + ", memberAge=" + memberAge + ", memberMinAge=" + memberMinAge
				+ ", memberMaxAge=" + memberMaxAge + ", productID=" + productID + ", productBrand=" + productBrand
				+ ", productName=" + productName + ", productCategory=" + productCategory + ", productInfo="
				+ productInfo + ", productImg=" + productImg + ", productPrice=" + productPrice + ", productStock="
				+ productStock + ", SearchKeyword=" + SearchKeyword + "]";
	}
